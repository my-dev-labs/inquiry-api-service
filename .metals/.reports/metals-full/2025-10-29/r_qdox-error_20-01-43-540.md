error id: file://<WORKSPACE>/test_scala_serializable.java
file://<WORKSPACE>/test_scala_serializable.java
...
```java
offset: 1
uri: file://<WORKSPACE>/test_scala_serializable.java
text:
```scala
 @@
```
...
QDox parse error in file://<WORKSPACE>/test_scala_serializable.java